            ...
            if item.carbs > 0 {
                result.append(
                    MacroPoint(
                        dayLabel: label,
                        macro: "Carbs",
                        // 🟢 FIX: Decimal sicher zu Double umgewandelt
                        kcal: Double(truncating: item.carbs as NSNumber) * 4.0,
                        color: carbsColor
                    )
                )
            }
            ...
            if item.fat > 0 {
                result.append(
                    MacroPoint(
                        ...
                        macro: "Fat",
                        // 🟢 FIX: Decimal sicher zu Double umgewandelt
                        kcal: Double(truncating: item.fat as NSNumber) * 9.0,
                        color: fatColor
                    )
                )
            }
            ...
            if item.protein > 0 {
                result.append(
                    MacroPoint(
                        ...
                        macro: "Protein",
                        // 🟢 FIX: Decimal sicher zu Double umgewandelt
                        kcal: Double(truncating: item.protein as NSNumber) * 4.0,
                        color: proteinColor
                    )
                )
            }
